...
CREATE TABLE IF NOT EXISTS `category` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_foreignkey_category_department` (`department_id`),
  CONSTRAINT `c_fk_category_department_id` FOREIGN KEY (`department_id`) REFERENCES `department` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE IF NOT EXISTS `subcategory` (
  ...
  `created_at`  DATETIME DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_foreignkey_subcategory_category` (`category_id`),
  CONSTRAINT `c_fk_subcategory_category_id` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE IF NOT EXISTS `ticket` (
  ...
  KEY `index_foreignkey_ticket_category` (`category_id`),
  KEY `index_foreignkey_ticket_subcategory` (`subcategory_id`),
  ...
  CONSTRAINT `c_fk_ticket_category_id` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `c_fk_ticket_subcategory_id` FOREIGN KEY (`subcategory_id`) REFERENCES `subcategory` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
