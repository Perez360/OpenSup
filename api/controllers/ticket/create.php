...
class CreateController extends Controller {
    ...
    public function handler() {
        ...
        $this->departmentId = json_decode(Controller::request('departmentId'));
        $this->categoryId = json_decode(Controller::request('categoryId'));
        $this->subCategoryId =json_decode(Controller::request('subCategoryId'));
