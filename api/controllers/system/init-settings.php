    ...
    private function storeLanguages() {
     ...
     private function storeMockedDepartments() {
        ...
        foreach ($categories as  $categoryName) {
            ...
            $category->created_at = Date::getCurrentDate();
            $category->store();
        }
        ...
        foreach ($subCategories as  $ubCategoryName) {
            $subCategory = new SubCategory();
            $subCategory->name = $ubCategoryName;
            $subCategory->category_id = 1;
            $subCategory->created_at = Date::getCurrentDate();
            $subCategory->store();
        }
